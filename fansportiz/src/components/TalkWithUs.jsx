      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 relative">
        ...
        <img
          ...
          className="
            ...
            lg:top-16 lg:right-20
            xl:top-[2rem] xl:right-[15rem]
            w-16 md:w-20 lg:w-24
          "
        />
        <div className="">
          <button className="bg-white text-blue font-semibold text-xl leading-[100%] py-6 px-10 rounded shadow hover:bg-gray-100 transition">
            TALK WITH US
          </button>
        </div>
      </div>
