    ...
    return (
        <div className="bg-bluebg py-16 px-4">
            <div className="max-w-7xl mx-auto border-2 bg-white grid grid-cols-1 lg:grid-cols-3">
                <div className="flex justify-center items-center border-b lg:border-b-0 lg:border-r border-gray-300 h-full max-w-7xl">
                    <h1 className='font-jersey bg-[#F5F5F5] text-[64px] py-28 px-[82px] text-blue leading-[70px] text-left'>
                        Our offerings
                        <div className="w-[120px] h-1 bg-orange mt-2 " />
                    </h1>
                </div>
